...
To solve conflicts from Studio:
...
<1> The commit made by another collaborator flagged as conflicting.
...
<1> Everything between the characters `=======` and `branch ...` are the changes in Design Center conflicting with yours.
+
...
<1> Add your changes to the index.
