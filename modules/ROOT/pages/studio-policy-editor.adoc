...
[WARNING]
--
The custom policy editor is still in Beta and is available only for Enterprise Edition users of Anypoint Studio 6.1 or newer versions of 6.5.
...
+
image::studio-policy-editor-a01e0.png["A form for setting up a Mule Custom Policy project"]
+
...
image::studio-policy-editor-f4c04.png["A project overview with fields for runtime, server runtime, policy files, and documentation"]
--
...
+
image::studio-policy-editor-8a38d.png["A table with configuration properties, policy projects, property names, types, and values"]
+
