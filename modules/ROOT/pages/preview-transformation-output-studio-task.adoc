...
+
[TIP]
To reset the sample to the original scaffolding with placeholders, click the *rescafold button* image:dw-rescafold-button.png[rescafold]. Note that any sample data you provided is lost.
