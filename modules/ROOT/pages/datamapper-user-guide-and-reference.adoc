...
|xref:connectors:web-service-consumer-connector/index.adoc[Web Service Consumer] |Turns JSON requests to XML and back. Also turns a flow variable into an outbound property.
