...
. Add the -vm option to point to your specific JDK installation path. If you have multiple JDKs installed type '/usr/libexec/java_home -verbose' to see the full path to your JDKs.
+
