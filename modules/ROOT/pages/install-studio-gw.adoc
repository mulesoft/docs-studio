...
xref:1.x@api-manager::api-auto-discovery.adoc#configuration[API Autodiscovery] is a configuration that triggers discovery of APIs in a project and registration of those APIs to your Anypoint organization. You xref:1.x@api-manager::api-auto-discovery.adoc#configuration[configure auto-discovery] by adding a global element to your Studio project.
