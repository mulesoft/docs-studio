...
To start creating an API specification project in Studio, you must be logged in to Anypoint Platform. See xref:xref:set-credentials-in-studio-to.adoc[Configure Platform Credentials].

. In the taskbar at the top of the Anypoint Studio display, select *File* > *New* > *API Specificiation Project*.
...
Studio uses VCS to track the development of your API specification project and keep it syncronized with Design Center.
