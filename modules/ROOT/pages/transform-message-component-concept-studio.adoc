...
:page-aliases: 6.5.x@studio::transform-message-component-concept-studio.adoc
...
* DataWeave language can also be invoked anywhere via MEL functions, see xref:3.8@mule-runtime::mel-dataweave-functions.adoc[MEL DataWeave Functions].
