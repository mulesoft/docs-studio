...
. Starting from Studio application menu, click *Window*, (or *Application Studio* in Mac), and click *Preferences*.
...
. Starting from Studio application menu, click *Window*, navigate to *Open Perspective,* then select *Other...*
+
