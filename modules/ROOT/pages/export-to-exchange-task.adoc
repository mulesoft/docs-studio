...
+
Categories cannot be created from Studio directly. Refer to the xref:docs-exchange::to-manage-categories.adoc[Manage Categories] documentation to learn how to create Categories for your organization.
+
Custom Fields cannot be created from Studio directly. Refer to the xref:docs-exchange::to-manage-custom-fields.adoc[Manage Custom Fields] documentation to learn how to create Custom Fields for your organization.
+
