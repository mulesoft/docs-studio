...
+
Categories cannot be created from Studio directly. Refer to the xref:to-manage-categories.adoc[Manage Categories] documentation to learn how to create Categories for your organization.
+
