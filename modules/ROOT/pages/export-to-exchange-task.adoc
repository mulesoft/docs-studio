...
+
image::publish-project-to-exchange.png[alt=Right-click on project and selecting Anypoint Platform and Publish to Exchange.]
...
<1> *Descrition*: (optional) A description of your API specification.
<1> *Group ID* +
