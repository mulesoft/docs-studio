...
Import an AsyncAPI, OAS, or RAML API spec into a new Mule project or an existing one.
...
+
If you're not logged in, click the *Add Account* button to add your Anypoint Platform account.
...
. Select your Anypoint Platform username. 
+
If you're not logged in, you can click the *Add Account* button to add your Anypoint Platform account.
