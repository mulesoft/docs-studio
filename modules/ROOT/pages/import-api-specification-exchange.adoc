...
If your OAS 3.0 API specification includes callbacks, you must manually implement them. See <<oas3-callbacks,Implement OAS 3 Callbacks>>.
...
include::partial$implement-oas3-callbacks.adoc[leveloffset=1]
