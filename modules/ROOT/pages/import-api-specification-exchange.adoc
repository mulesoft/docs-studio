...
After changing your API spec, such as adding a new endpoint, re-scaffold the spec to update your Mule project.

. Right-click on the file.xml of your Mule project.
. Select *API Specs*, the name of your Mule project (filename.xml), and *Generate Flows*.

If your project is successfully rescaffolded, a new flow is added to your implementation XML file. 
