...
For supported protocols, see xref:apikit::apikit-asyncapi-module-reference.adoc#supported-message-brokers[] in APIkit for AsyncAPI Module Reference.

=== Access AsyncAPI Implementation Features

. Log in to Anypoint Platform.
. Open Anypoint Code Builder landing page.
...
When scaffolding an AsyncAPI specification into a Mule project (implementation or integration), Studio:
...
* https://trailhead.salesforce.com/trailblazer-community/topics/mulesofteda?sort=LAST_MODIFIED_DATE_DESC[Provide Feedback about AsyncAPI feature]
