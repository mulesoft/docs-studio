...
Because importing OAS 3.0 API specifications as an API dependency for your project is not supported, you cannot edit them following this process. To import an OAS 3.0 API specification as an editable API specification project, see xref:sync-api-projects-design-center.adoc[Synchronize API Specifications with Design Center].
