...
. To generate a flow for the updated version, right-click the Mule project where you updated the API version, and select *API Specs* > the name of your API > *Generate Flows*.
+
Studio generates xref:4.x@apikit::apikit-4-raml-flow-concept.adoc[a RAML-based flow] of the new version.
