...
+
image::dw-multiple-outputs-edit.png["Code showing a list of payment data fields, including coin, payments, and type"]

. Select the 'File' radio button.
+
image::dataweave-externalfile2.png["A dialog box with options for selecting a target file"]
