...
While Windows Defender is a tool for keeping your computer safe, it can also slow down the performance of Studio because it scans files in real-time as they are accessed, which causes delays. To prevent performance issues, you can completely exclude Studio from Windows Defender scans. 

. Run Studio. The following Windows Defender notice pop-ups to ask if Studio folders and processes should be excluded:
+
