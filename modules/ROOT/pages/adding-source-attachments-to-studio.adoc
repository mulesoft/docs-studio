...
[NOTE]
For modules which are part of the enterprise edition of Mule, source code is not available out of the box. If you need access to the source of these libraries, you can https://help.mulesoft.com[Contact MuleSoft Support] explaining your use case and why you require it.
