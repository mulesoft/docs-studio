...
MUnit is fully integrated in Studio.
...
//TODO: Make the list of tasks you can perform in Studio with MUnit and create a link from each bullet to the content in this very same page
* Create a test
* Create a test suit
* Run a test
* Debug your project
...
When you run a test, Studio creates a build and displays the progress and the result of the test in the *Console* tab and in the *MUnit* window.
...
//TODO: List the steps to run an MUnit test, a test suite, etc. As there are more than one options to run a test, list them all.

== Monitor Your Tests and Review the Test Results


If the test results indicate any failures, learn more about this failure on the error section.
