...
image::allavailablesites.png["A catalog of software for installation, with filtering and selection options"]
...
+
image::about-studio.png["A menu titled "About Anypoint Studio" with options for preferences, services, hiding windows, and quitting the application"]

. Click *Installation Details*.
+
image::36aboutanyptstudio.png["An orange button labeled "Installation Details" with an arrow pointing to it"]
...
+
image::36extensions.png["A list of software versions and IDs"]
