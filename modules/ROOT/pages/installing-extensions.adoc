...
:page-aliases: 6.5.x@studio::installing-extensions.adoc
...
* xref:3.8@mule-runtime::installing-connectors.adoc[Anypoint Connectors]
...
* Want to create your own Mule extension? Access the xref:3.8@connector-devkit::index.adoc[Anypoint Connector DevKit] documentation for details.
