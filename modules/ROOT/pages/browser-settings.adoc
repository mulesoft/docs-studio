...
. Download the latest fixed version of WebView2 from the https://developer.microsoft.com/en-us/microsoft-edge/webview2/?form=MA13LH[Microsoft Developer Portal^].
