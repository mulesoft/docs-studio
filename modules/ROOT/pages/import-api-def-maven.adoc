...
Anypoint Studio allows you to import an API Definition in a Maven repository and implement it into both, a new Mule Project, or into an existing one.
...
== Implementing an API from Maven Into an Existing Project
