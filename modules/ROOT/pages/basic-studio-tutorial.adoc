...
able to apply what you have learned to create xref:general:getting-started:content-based-routing.adoc[more complex applications].

== Prerequisites

Before going any further, make sure you have xref:download-and-launch-anypoint-studio.adoc[downloaded and installed Anypoint Studio]. If you do not have any previous experience with https://eclipse.org/[Eclipse] or an Eclipse-based IDE, review the brief introduction to the xref:index.adoc[Anypoint Studio interface].
...
Congratulations! You're all set to go on to the xref:general:getting-started:content-based-routing.adoc[Content-Based Routing].
