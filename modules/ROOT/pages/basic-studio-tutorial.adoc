...
This tutorial walks you through how to use Anypoint Studio to build a simple HTTP request-response application.

== Prerequisites

This tutorial assumes that you have xref:to-download-and-install-studio.adoc[downloaded and installed Anypoint Studio]. If you do not have any previous experience with Eclipse or an Eclipse-based IDE, you can review the brief introduction to the xref:index.adoc[Anypoint Studio interface].
