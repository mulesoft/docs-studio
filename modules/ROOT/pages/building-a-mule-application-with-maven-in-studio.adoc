...
:page-aliases: 6.5.x@studio::building-a-mule-application-with-maven-in-studio.adoc
...
----
<1> This class extends FunctionalTestCase, which is Mule's implementation of an abstract JUnit test case. For more information, see xref:3.8@mule-runtime::functional-testing.adoc[Functional Testing].
...
* Read more about xref:3.8@mule-runtime::using-maven-with-mule.adoc[Using Maven with Mule].
...
* Access additional Maven xref:3.8@mule-runtime::maven-reference.adoc[reference] and xref:3.8@mule-runtime::configuring-maven-to-work-with-mule-esb.adoc[configuration] information.
