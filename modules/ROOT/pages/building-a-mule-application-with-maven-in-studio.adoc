...
* Line number 12: This class extends FunctionalTestCase, which is Mule's implementation of an abstract JUnit test case. For more information, see xref:3.7@mule-runtime::functional-testing.adoc[Functional Testing].
...
* Read more about xref:3.7@mule-runtime::using-maven-with-mule.adoc[Using Maven with Mule].
...
* Access additional Maven xref:3.7@mule-runtime::maven-reference.adoc[reference] and xref:3.7@mule-runtime::configuring-maven-to-work-with-mule-esb.adoc[configuration] information.