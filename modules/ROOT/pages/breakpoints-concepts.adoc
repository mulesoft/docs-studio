...
image::add-breakpoint.png["The Add breakpoint option highlighted in the context menu of a flow"]

To disable the breakpoint, right-click the message processor and select *Disable Breakpoint*:

image::disable-breakpoint.png["The Disable breakpoint option highlighted in the context menu of a flow"]
...
image::disabled-breakpoint.png["A gray circle shows a disabled breakpoint"]
...
image::breakpoint-activation.png["The elements of the Mule Breakpoints view in the Mule Debug perspective"]
...
+
image::set-conditional-breakpoint.png["Set Payload and Conditional elements highlighted In the Mule Breakpoints view"]
...
To disable error breakpoints, select the *Disable error breakpoints* (image:to-set-error-breakpoints-55f71.png["Disable error breakpoints icon"]") button in the *Mule Breakpoints* view:

image::disable-error-breakpoint.png["Disable error breakpoints button highlighted in the Mule Breakpoints view"]
...
image::mute-breakpoints.png["The Mute breakpoints icon highlighted in the Mule Breakpoints view"]
...
image::mute-disable-error-breakpoints.png["The Mute breakpoints disables Error Breakpoints checkbox highlighted in the Anypoint Studio Preferences menu"]
