...
Anypoint Studio enables you to import a RAML, OAS 2.0, or OAS 3.0 API specification from Design Center into an API Project in Studio to edit it offline, and stage and push your changes as you would do with any version control system (VCS).
