...
:page-aliases: 6.5.x@studio::previewing-datamapper-results-on-sample-data.adoc
:keywords: datamapper
...
image::datamapperscreenshot11.png[]
...
image::datamapperscreenshot22.png[]

DataMapper displays the Preview pane, shown below.

image::datamapperxmltojson.png[]
...
image::datamapperscreenshot4.png[]
...
image::datamapperscreenshot8.png[]
