...
== Accessing the Metadata Editor (Metadata Tab)
...
== Accessing the Metadata Editor (Transform Message Component)
...
== Accessing the Metadata Editor (Package Explorer View)
