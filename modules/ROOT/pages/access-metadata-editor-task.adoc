...
== Accesing the Metadata Editor (Metadata Tab)
...
== Accesing the Metadata Editor (Transform Message Component)
...
== Accesing the Metadata Editor (Package Explorer View)
...
* xref:create-metadata-class-task.adoc[Creating Metadata Class]
* xref:4.1@mule-runtime::transform-input-output-structure-transformation-studio-task.adoc[Defining Input and Output Structure of a Transformation]
