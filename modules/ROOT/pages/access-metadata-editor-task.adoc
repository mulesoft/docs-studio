...
. Click the Edit icon image:access-metadata-editor-task-93b19.png["Edit icon"] to open the Metadata Editor.

For example, this is the metadata tab for an HTTP Listener source:

image::access-metadata-editor-task-320a3.png["The metadata tab highlighted displaying the metadata of a flow"]
...
+
image::access-metadata-editor-task-b0be6.png["The set metadata option highlighted in a transform message component"]
