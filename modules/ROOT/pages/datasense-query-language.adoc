...
:page-aliases: 6.5.x@studio::datasense-query-language.adoc
...
The DataSense Query Language is, in fact, a basic subset of https://en.wikipedia.org/wiki/SQL[SQL]. The tables below list the supported language elements and operators.
