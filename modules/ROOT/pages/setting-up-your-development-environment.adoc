...
[NOTE]
--
Studio versions 6.1.1 and later allow you to log in to Anypoint Platform using your configured xref:access-management::external-identity.adoc[federated external identity].
...
Anypoint Studio versions 6.2 and later support the xref:private-cloud::index.adoc[Anypoint Platform Private Cloud Edition (Anypoint Platform PCE)] version 1.7 and earlier.
...
image::setting-up-your-development-environment-cdf6d.png["A preferences window for the Anypoint Platform Private Edition"]
...
image::setting-up-your-development-environment-67928.png["Preferences window with an exchange URL and settings"]
