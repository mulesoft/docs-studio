...
. Configure xref:api-sync-reference.adoc[API Sync] and link:/api-manager/api-auto-discovery[API Autodiscovery] for APIs in your Private Cloud Edition platform.
