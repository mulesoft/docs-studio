...
[NOTE]
--
https://archive.docs.mulesoft.com/release-notes/studio/anypoint-studio-6.1-with-3.8.1-runtime-update-site-1-release-notes[Studio 6.1.1] and newer allows you to log-in to Anypoint Platform using your configured xref:access-management::external-identity.adoc[federated external identity].
...
https://archive.docs.mulesoft.com/release-notes/studio/anypoint-studio-6.2-with-3.8.3-runtime-release-notes[Anypoint Studio 6.2] and higher support the xref:private-cloud::index.adoc[Anypoint Platform Private Cloud Edition (Anypoint Platform PCE)] version 1.7 and earlier.
