...
xref:release-notes::studio/anypoint-studio-6.2-with-3.8.3-runtime-release-notes.adoc[Anypoint Studio 6.2] and higher support the xref:1.5@private-cloud::index.adoc[Private Cloud Edition] of Anypoint Platform version 1.7 and earlier.
