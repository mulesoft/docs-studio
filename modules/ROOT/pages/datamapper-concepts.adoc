...
[TIP]
====
For instructions on how to do this see xref:general:getting-started:anypoint-connector.adoc[Anypoint Connector quickstart], under the section *Obtaining Access to the Twitter API*.
====
+
