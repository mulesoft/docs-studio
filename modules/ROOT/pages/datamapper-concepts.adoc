...
[TIP]
====
For instructions on how to do this see the xref:general:getting-started:anypoint-connector.adoc[Anypoint Connector Tutorial], under the section *Obtaining Access to the Twitter API*.
====
+
