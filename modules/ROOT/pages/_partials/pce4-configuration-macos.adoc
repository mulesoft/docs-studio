...
For example, if you're using the embedded Java 17 in macOS:
...
For example, if you're using the embedded Java 8 in Windows:

[source,xml,linenums]
----
keytool -import -trustcacerts -keystore "C:[...]\AnypointStudio\7.19.0\plugins\org.mule.tooling.jdk.win32.x86_64_1.3.3\lib\security\cacerts" -storepass changeit -file /tmp/PCE_Certificate.cer
----
