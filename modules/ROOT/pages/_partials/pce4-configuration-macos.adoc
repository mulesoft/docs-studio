...
Anypoint Studio 7.19 and later adds support for Anypoint Platform PCE version 4.0.0. in macOS. 

== Configure Your PCE Certificates into Studio

Integrate your Studio installation with the Anypoint Platform components in a PCE deployment.

=== Determine the Java Version and Location

. Open Studio.
. Go to *Anypoint Studio > Settings> Preferences > Java > Installed JRES*.
...
. In Studio, go to *Anypoint Studio* > *Preferences* > *Anypoint Studio* > *Anypoint Platform*.
+
