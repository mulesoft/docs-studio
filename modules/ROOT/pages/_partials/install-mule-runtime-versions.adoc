...
If you choose to use a different Mule version than the one bundled in your Studio distribution, you can install the latest compatible Mule version.

[NOTE]
Older runtime versions aren't available for installation.
