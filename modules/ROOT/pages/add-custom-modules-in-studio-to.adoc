...
See the xref:mule-sdk::getting-started.adoc[Mule SDK introductory instructions] for more details.
...
* xref:mule-sdk::getting-started.adoc[Get Started with the Mule SDK]
