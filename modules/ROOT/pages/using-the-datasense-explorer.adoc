...
This document assumes you are familiar with Mule ESB and the xref:index.adoc[Studio interface]. Further, it assumes you have read the xref:3.7@mule-runtime::mule-message-structure.adoc[Mule Message Structure document] to understand the contents of a Mule message. To increase your familiarity with Studio, consider reading xref:index.adoc[Anypoint Studio Essentials].
...
|image:enricherscope.png[]
|image:metadata6.png[]
|The xref:3.7@mule-runtime::flow-reference-component-reference.adoc[flow reference] in the previous step sent the message to a new flow.
...
* Learn more about the xref:3.7@mule-runtime::mule-message-structure.adoc[Mule message] and how to work with it.
* Work through the xref:general:getting-started:mule-message.adoc[Mule Message Tutorial] to learn more.
...
* Get familiar with xref:3.7@mule-runtime::mule-expression-language-mel.adoc[Mule Expression Language] so that you can access and manipulate the contents of your message and its environment.