...
This document assumes that you are familiar with the xref:index.adoc[Visual Editor in Anypoint Studio], the xref:3.7@mule-runtime::anypoint-connectors.adoc[Anypoint Connectors], and the xref:3.7@mule-runtime::dataweave.adoc[DataWeave] transformer that you can use to create applications in Studio. Further, this document references xref:3.7@mule-runtime::connecting-using-transports.adoc[Connectors] and xref:3.7@mule-runtime::global-elements.adoc[Global Elements.]
