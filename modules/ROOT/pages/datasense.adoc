...
:page-aliases: 6.5.x@studio::datasense.adoc
...
This document assumes that you are familiar with the xref:index.adoc[Visual Editor in Anypoint Studio], the xref:3.8@mule-runtime::anypoint-connectors.adoc[Anypoint Connectors], and the xref:3.8@mule-runtime::dataweave.adoc[DataWeave] transformer that you can use to create applications in Studio. Further, this document references xref:3.8@mule-runtime::connecting-using-transports.adoc[Connectors] and xref:3.8@mule-runtime::global-elements.adoc[Global Elements.]
...
. Lastly, insert any xref:3.8@mule-runtime::dataweave.adoc[DataWeave transformers] into your flow to adjust the format or structure of the message so that each connector receives the input it expects.
