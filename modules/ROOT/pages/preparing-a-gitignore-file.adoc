...
:page-aliases: 6.5@studio::preparing-a-gitignore-file.adoc
...
This document assumes familiarity with https://git-scm.com/[git] as a software version control system, and that you are using xref:6@index.adoc[Anypoint Studio] to build a new application that you intend to manage using git.
...
* Learn about xref:using-subversion-with-studio.adoc[Using Subversion with Studio].
