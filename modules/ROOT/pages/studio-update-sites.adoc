...
To add a local update site ensure that your update site is a JAR or ZIP file format and complete these steps:
...
If you're on a network that has firewall restrictions, you must allow the URLs of the update sites to download extensions:

. Navigate to *Help* > *Install New Software*.
. Click *Manage*.
The list of available software is shown.
+
