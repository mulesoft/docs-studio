...
:page-aliases: 6.5@studio::studio-update-sites.adoc
...
*Note*: You need an Enterprise license to run applications containing xref:3.9@mule-runtime::anypoint-enterprise-security.adoc[Anypoint Enterprise Security] features.
