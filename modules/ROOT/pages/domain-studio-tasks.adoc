= Designing Mule Domains (Anypoint Studio)
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

== Creating Mule Domains
...
== Associating a Mule Application to a Mule Domain
...
== Installing your Mule Domain in an M2 Repository
...
* xref:add-modules-in-studio-to.adoc[Adding Modules to Your Project (Anypoint Studio)]
