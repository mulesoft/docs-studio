...
More information about https://maven.apache.org/settings.html[Maven setting references^]

To configure Maven setting preferences, go to *Anypoint Studio > Settings…* and click *Maven*.

More information about configuration of MuleSoft repositories at https://docs.mulesoft.com/studio/latest/maven-preferences-reference[Maven Reference documentation].
