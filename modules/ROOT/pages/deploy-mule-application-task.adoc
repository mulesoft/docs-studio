= To Deploy a Mule Application to CloudHub (Anypoint Studio)
...
+
See the xref:4.1@mule4-runtime::how-to-export-resources.adoc[How to Export Resources] task to learn more about working with external resources in your Mule application.
