...
This is the same as using the `-DattachMuleSources` flag when packaging using the Mule Maven Plugin. See xref:4.1@mule-runtime::package-task-mmp.adoc[To Package a Mule Application (Mule Maven Plugin)] for more information.
+
