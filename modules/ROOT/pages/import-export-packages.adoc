...
This is the same as using the `-DattachMuleSources` flag when packaging using the Mule Maven Plugin. See xref:4.1@mule-runtime::mmp-concept#mule-application-packaging.adoc[Mule Application Packaging] for more information.
+
...
* xref:4.1@mule-runtime::mmp-concept.adoc[Mule Maven Plugin]
