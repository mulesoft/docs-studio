...
[NOTE]
Duplicated copies of your specification can be created in your local drive. You can only keep RAML API specifications as local copies within your project's structure.
