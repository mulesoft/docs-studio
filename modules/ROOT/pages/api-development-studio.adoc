...
+
You can also xref:create-api-specification-studio.adoc[create an API project in Studio and syncrhonize it with Design Center].
...
You can start xref:create-api-specification-studio.adoc[an API project in Studio and syncronize it with Design Center]. Studio uses version control system (VCS) capabilities to keep your API specifications syncronized between your Studio's workspace and Design Center.

You can also import an API specification from Design Center as a an API project with VCS enabled capabilities to edit your API specification using Studio and synchronize your changes with Design Center:
