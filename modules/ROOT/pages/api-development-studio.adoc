...
You can import an API specification from Design Center as a an API project with version control system (VCS) enabled capabilities to edit your API specification using Studio and synchronize your changes with Design Center:
