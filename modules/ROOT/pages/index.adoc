...
The same editor also allows you to create domains that define xref:3.8@mule-runtime::shared-resources.adoc[shared resources].
...
Studio visual editor is divided into five parts:
...
Because Anypoint Studio leverages Eclipse, the Configuration XML editor incorporates many Eclipse features. The following is a list of handy tips and tricks for using Studio XML editor.
...
Note that the *DataSense Explorer* at the right side of the properties editor provides helpful information about the data structure and metadata of your message as it enters and exits this particular building block. You can toggle the DataSense Explorer on and off by clicking this icon: image:datasenseexplorericon.png[]
...
* Learn more about flows in xref:3.7@mule-runtime::mule-application-architecture.adoc[Mule Application Architecture].
* Skip ahead to learn about xref:3.7@mule-runtime::mule-message-structure.adoc[Mule message structure].
