...
:page-aliases: 6.5.x@studio::index.adoc
...
* Studio 6.x doesn't use some features in Windows because Anypoint Platform no longer supports Internet Explorer (see xref:general::browser-support.adoc[Browser Support for Anypoint Platform]).
