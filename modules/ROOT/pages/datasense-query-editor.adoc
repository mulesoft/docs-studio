...
:page-aliases: 6.5.x@studio::datasense-query-editor.adoc
...
Using the Query Editor in conjunction DataSense's xref:using-perceptive-flow-design.adoc[perceptive flow design] facilitates designing and building a SaaS integration flow. You create complex mappings by placing a xref:3.8@mule-runtime::dataweave.adoc[DataWeave transformer] before or after a connector in your flow.

== Assumptions

This document assumes that you are familiar with the xref:index.adoc[Visual Editor in Anypoint Studio], as well as the xref:3.8@mule-runtime::anypoint-connectors.adoc[Anypoint Connectors], in particular the Salesforce cloud connector used in the example queries. This document also references xref:3.8@mule-runtime::anypoint-connectors.adoc[Connectors], xref:3.8@mule-runtime::global-elements.adoc[Global Elements], and xref:datasense.adoc[DataSense]. To learn more about developing with Mule's graphical user interface, review xref:index.adoc[Getting Started with Anypoint Studio].

== Using the Query Editor

The table below lists the xref:3.8@mule-runtime::anypoint-connectors.adoc[Anypoint Connectors] which support Query Editor functionality. (Additionally, you can use the Query Editor with any custom-built connector which supports the query functionality.)
...
. To access the Query Editor, add a connector to your flow, then access its xref:6@index.adoc#properties-editor[Properties Editor.]
...
. Create a Salesforce xref:3.8@mule-runtime::global-elements.adoc[Global Element].
