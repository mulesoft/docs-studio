...
. Copy the `mule-debugger-mule-server-plugin.jar` artifact and paste it in the `MULE_HOME/server-plugins` directory of your remote Mule instance.
* Before accessing and debugging your application on a remote Mule instance, you must first export and deploy your application to the desired instance.
