...
xref:3.7@mule-runtime::using-maven-in-mule-esb.adoc[Using Maven in Mule ESB].

For basic details on Maven, see xref:3.7@mule-runtime::maven-reference.adoc[Maven Reference].