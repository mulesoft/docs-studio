...
:page-aliases: 6.5.x@studio::using-maven-in-anypoint-studio.adoc
...
xref:3.8@mule-runtime::using-maven-in-mule-esb.adoc[Using Maven in Mule ESB].

For general basic details on Maven, see xref:3.8@mule-runtime::maven-reference.adoc[Maven Reference].
====
