...
. Click the *Edit Current Target* button image:using-dataweave-in-studio-47984.png["A gray pencil icon"] above the DataWeave code editor.
...
+
image::dw-new-variable.png["A dialog box with fields for selecting a variable name and source code location"]
