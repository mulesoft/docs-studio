...
. Select *File* > *New* > *Mule Project* to create a project, and set the field values in the project wizard:
+
...
+
Logging previously into Anypoint Platform, makes your Username and Business Group details grayed out.
+
...
== Implementing an API imported from Design Center Into an Existing Project
