...
.. To the right of the *Location* field, click the "..." button to and select *Design Center*.
. In the Browse Design Center for APIs window:
* Select your Anypoint Platform username and business group.
+
If you are logged into AnyPoint Platform, your username and business group will be grayed out.
+
