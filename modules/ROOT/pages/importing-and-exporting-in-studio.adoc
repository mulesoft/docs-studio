...
|*Mule extension Update Site* |Specific to xref:3.8@connector-devkit::index.adoc[DevKit] connector extension projects, this option allows you to export the project to an update website. This option only appears if you have installed the DevKit plugin for Anypoint Studio.
|===
