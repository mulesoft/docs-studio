...
Anypoint Studio allows you to import an API Definition from Exchange and implement it either into a new Mule Project, or into an existing one.
...
. In the *Add API Specification Dependency* tab, click the plus icon, and select *From Exchange*
...
+
image::import-api-definition-2f3e3.png[import-api-definition-2f3e3]
+
...
. Click the plus icon, and select *From Exchange*.
...
APIKit generates a new Mule configuration file with the flow based on the API definition you just imported.
