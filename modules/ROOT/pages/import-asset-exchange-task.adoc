...
If you are having trouble accessing Exchange from Studio 6, follow the following steps to import an asset from Exchange from outside Studio:
...
. Select *Download* to download the asset.
+
