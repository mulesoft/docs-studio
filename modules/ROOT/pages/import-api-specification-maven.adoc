...
Using API Sync, Anypoint Studio enables you to import a RAML or OAS API specification into either a new Mule project or an existing one.
...
You can add either a RAML or OAS specificaiton, or a ZIP bundle file as your API specification, and click *Open*.
