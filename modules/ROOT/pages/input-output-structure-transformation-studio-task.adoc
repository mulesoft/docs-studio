...
+
See xref:defining-metadata.adoc[Defining Metadata].
...
See xref:3.9@mule-runtime::dataweave-xml-reference.adoc#defining-metadata-via-xml[DataWeave XML Reference].
...
+
image::dw-reader-configuration-select.png["A menu with options to Set Metadata, Clear Metadata, Edit Sample Data, and Reader Configuration"]
...
* xref:1.2@dataweave::dataweave-formats.adoc#csv[CSV]

* xref:1.2@dataweave::dataweave-formats.adoc#xml[XML]

* xref:1.2@dataweave::dataweave-formats.adoc#flat-file[Flat File]
...
* xref:1.2@dataweave::dataweave-formats.adoc#json[JSON]
...
* xref:1.2@dataweave::dataweave-formats.adoc[DataWeave Formats]
* xref:3.9@mule-runtime::dataweave-xml-reference.adoc#reader-configuration[DataWeave XML reference]
