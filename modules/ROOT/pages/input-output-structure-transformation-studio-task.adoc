...
* xref:4.1@mule-runtime::dataweave-formats.adoc#csv[CSV]

* xref:4.1@mule-runtime::dataweave-formats.adoc#xml[XML]

* xref:4.1@mule-runtime::dataweave-formats.adoc#flat-file[Flat File]
...
* xref:4.1@mule-runtime::dataweave-formats.adoc#json[JSON]
