...
See xref:4.1@mule4-runtime::transform-dataweave-xml-reference.adoc[DataWeave XML Reference].
...
* xref:4.1@mule4-runtime::dataweave-formats.adoc#csv[CSV]

* xref:4.1@mule4-runtime::dataweave-formats.adoc#xml[XML]

* xref:4.1@mule4-runtime::dataweave-formats.adoc#flat-file[Flat File]
...
* xref:4.1@mule4-runtime::dataweave-formats.adoc#json[JSON]
...
* xref:4.1@mule4-runtime::dataweave-types.adoc[DataWeave Types]
* xref:4.1@mule4-runtime::dataweave-formats.adoc[DataWeave Formats]
* xref:4.1@mule4-runtime::transform-dataweave-xml-reference.adoc[DataWeave XML reference]