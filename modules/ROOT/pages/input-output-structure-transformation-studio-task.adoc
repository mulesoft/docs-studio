= Defining Input and Output Structure of a Transformation
...
* xref:mule-runtime::dataweave-formats.adoc#csv[CSV]

* xref:mule-runtime::dataweave-formats.adoc#xml[XML]

* xref:mule-runtime::dataweave-formats.adoc#flat-file[Flat File]
...
* xref:mule-runtime::dataweave-formats.adoc#json[JSON]
...
* xref:mule-runtime::dataweave-types.adoc[DataWeave Types]
