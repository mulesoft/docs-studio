= Defining Input and Output Structure of a Transformation (Anypoint Studio)
...
See xref:4.1@mule-runtime::transform-dataweave-xml-reference.adoc[DataWeave XML Reference].
...
* xref:2.1@dataweave::dataweave-formats.adoc#csv[CSV]

* xref:2.1@dataweave::dataweave-formats.adoc#xml[XML]

* xref:2.1@dataweave::dataweave-formats.adoc#flat-file[Flat File]
...
* xref:2.1@dataweave::dataweave-formats.adoc#json[JSON]
...
* xref:2.1@dataweave::dataweave-types.adoc[DataWeave Types]
* xref:2.1@dataweave::dataweave-formats.adoc[DataWeave Formats]
* xref:4.1@mule-runtime::transform-dataweave-xml-reference.adoc[DataWeave XML reference]
