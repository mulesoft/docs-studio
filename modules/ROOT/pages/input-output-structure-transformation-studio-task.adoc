...
See xref:3.8@mule-runtime::dataweave-xml-reference.adoc#defining-metadata-via-xml[DataWeave XML Reference].
...
* xref:3.8@mule-runtime::dataweave-formats.adoc#csv[CSV]

* xref:3.8@mule-runtime::dataweave-formats.adoc#xml[XML]

* xref:3.8@mule-runtime::dataweave-formats.adoc#flat-file[Flat File]
...
* xref:3.8@mule-runtime::dataweave-formats.adoc#json[JSON]
...
* xref:3.8@mule-runtime::dataweave-formats.adoc[DataWeave Formats]
* xref:3.8@mule-runtime::dataweave-xml-reference.adoc#reader-proerties[DataWeave XML reference]
