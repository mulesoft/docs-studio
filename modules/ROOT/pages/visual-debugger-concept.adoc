...
| Studio debugger listens to incoming TCP connections on `localhost` and port `6666`. To temporarily prevent the debugger from triggering or processing incoming requests, click *Suspend* to pause debugger listening activities. 
| 
