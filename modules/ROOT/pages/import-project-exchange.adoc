...
. Click the *Open Exchange* button on the top navigation bar image:import-project-exchange-c2fce.png["An infinity symbol"].
...
+
image::import-project-exchange-7f6a4.png["An icon of a folder with a downward arrow, labeled "Open""]
