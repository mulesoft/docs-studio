...
----
~/Downloads Agents
cp bc-fips-1.0.2.4.jar /Applications/AnypointStudio.app/Contents/Eclipse/plugins/org.mule.tooling.jdk.v8.macosx.x86_64_1.3.4/Contents/Home/jre/lib/ext/
----
+
. Register the security provider in the security properties file at the JDK8 lib/security folder to set the bouncy castle providers.
+
----
#
...
+
. Save your changes.
. In Studio, open the *Run configuration* of your project.
...
+
The startup readout shows FIPS security mode enabled.
+
----
...
* Host: martins-macbook-pro-2.local (10.250.0.81)
...
* - mule.base = /Users/martinbuchwald/Desktop/Standalones/mule-enterprise-standalone-4.1.1-8002
  - mule.home = /Users/martinbuchwald/Desktop/Standalones/mule-enterprise-standalone-4.1.1-8002
----
[calloutlist]
...
* TLS: bctls-fips-1.0.19.jar
* PKIX: bcpkix-fips-1.0.7.jar
. Copy the downloaded files to the embedded Mule runtime folder located at /Applications/AnypointStudio.app/Contents/Eclipse/plugins/org.mule.tooling.server.4.9.ee_7.21.0.202507071837/lib/boot.
. In Studio, open the *Run configuration* of your project.
. Go to the *Arguments* tab. In *VM arguments*, add:
----
