...
+
Studio analyzes the modules in your Mule project and shows the connectors that aren't Java 17 compatible in the *Problems* tab.  
. xref:update-modules.adoc[Update modules] that aren’t Java 17 compatible.
