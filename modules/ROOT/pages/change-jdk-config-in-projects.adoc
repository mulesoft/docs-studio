= Update the JDK Version from Studio
ifndef::env-site,env-github[]
include::_attributes.adoc[]
endif::[]

You can change the version of the JDK used to run your Mule project from Studio.

[NOTE]
Anypoint Studio 7.3 and later require JDK 1.8 to launch. +
These instructions change the JDK used to start up your Mule runtime in your Studio testing environment.
